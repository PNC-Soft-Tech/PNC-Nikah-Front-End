  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-screen-md mx-auto bg-white p-6 rounded-lg shadow-md">
        <h1 className="text-3xl font-semibold text-center mb-8" style={{color:Colors.titleText}}>Terms and Conditions</h1>
        
        <p className="text-gray-700 mb-6">
          Please read these Terms and Conditions carefully before using our website. By accessing or using the service, 
          you agree to be bound by these Terms. If you disagree with any part of the terms, please do not use our website.
        </p>
        
        <h2 className="text-2xl font-semibold mb-4">1. Use of Website</h2>
        <p className="text-gray-700 mb-6">
          This website is for general information and use only. It is subject to change without notice.
        </p>
        ...
        <p className="text-gray-700 mb-6">
          We may revise these Terms and Conditions at any time without prior notice. By using this website, you are agreeing 

    ...
    <div className="flex flex-row">
      <div className="min-h-screen w-[22%] bg-white border-l-2 border-gray-400 flex-col ">
        <div className=" flex flex-col mt-4">
          ...
          <button className="h-10 w-36 text-[20px] rounded-full p-1 text-[#ffff] self-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 mt-3 ">
            My Biodata
          </button>
        </div>
        <div className=" mt-6  ">
      ...
      <div className=" min-h-screen w-[78%] bg-gray-100 px- pt-12 pb-8 flex flex-row gap-12 justify-evenly ">

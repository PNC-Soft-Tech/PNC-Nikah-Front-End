...
const Instructions = () => {
  ...
  const toggleItem = (index) => {
    ...
    updatedInstructionItems[index].isOpen = !updatedInstructionItems[index].isOpen;
    setInstructionItems(updatedInstructionItems);
  };

  return (
    <div className="max-w-2xl mx-auto mt-8 mb-8">
      <h1 className="text-xl md:text-2xl lg:text-3xl font-semibold mb-4" style={{color:Colors.titleText}}>নির্দেশনা সমুহ</h1>
      <ul>

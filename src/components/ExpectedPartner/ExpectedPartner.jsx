        ...
        <tbody>
          ...
          <tr className="border-b">
            ...
            <td className="px-4 py-2 text-left  w-1/2 border-l">
              ...
              হবে। হেদায়েতপ্রাপ্ত। যে দ্বীনের ওপর মৃত্যুর আগ পর্যন্ত দৃঢ় থাকার
              দোয়া করে এবং সে অনুযায়ী আমল করে। মুসলিম উম্মাহর অবস্থা নিয়ে
              যিনি ভাবেন,ইসলামের দাওয়াত দেয়ার মনােভাব রাখেন। আল্লাহর
              সন্তুষ্টির জন্য যিনি জীবন উৎসর্গ করে শহীদ হওয়ার ইচ্ছা রাখেন।
              জীবিকা নির্বাহের জন্য হালাল কাজ করতে হবে। অনলাইন, অফলাইন এবং
              কর্মক্ষেত্রে নজরের হিফাজত ও মাহরাম,গায়রে-মাহরাম মেনে চলার
              কঠোরভাবে সর্বোচ্চ চেষ্টা করতে হবে। ফরজ ইবাদতের পাশাপাশি সুন্নত ও
              নফল ইবাদতের প্রতিও যত্নশীল হতে হবে। (যেমন, নফল সালাত,নফল
              সাওম।)আল্লাহর সন্তুষ্টির জন্য দানসদাকা করার অভ্যাস থাকতে হবে। আমার
              আম্মু-বাবার ব্যাপারে জীবনসঙ্গীকে শ্রদ্ধাশীল হতে হবে। সত্যিকার
              অর্থে তাদের ছেলে হয়ে উঠবে। তাদের প্রতি যত্নবান ও দ্বায়িত্বশীল হবে
              এটাই কাম্য। মিথ্যা এবং গীবত এগুলাে থেকে সমসময় নিজেকে পবিত্র রাখার
              চেষ্টায় থাকবেন যিনি। যিনি নিজেকে রিয়ামুক্ত রাখার চেষ্টায় রত।
              (মানে লােক দেখানাে আমল করেন না।) সর্বপরি যিনি আমার রাসুল (সাঃ) এর
              যোগ্য উম্মত হবেন, উত্তম আখলাকের অধিকারী, নেক চরিত্রবান একজন পুরুষ।
              যিনি মুহসিনীন ও মুখলেসীন বান্দা। ইভেনচুয়ালি যিনি আমার
              চক্ষুশীতলকারী হবেন। বিয়ের সব কাজ-কর্ম সুন্নাহ মেনে সম্পূর্ণ করার
              ইচ্ছে থাকতে হবে ইন-শা-আল্লাহ।
            </td>
          </tr>
          <tr className="border-b">
            <td className="px-4 py-2 text-left  w-1/2">

      ...
      <table className="table-auto w-full">
        <thead>
          <tr className="border-b border-t">
            ...
            <td className="px-4 py-2 text-left  w-1/2 border-l">জেনারেল</td>
          </tr>
        </thead>
        <tbody>
          <tr className="border-b">
            ...
            <td className="px-4 py-2 text-left  w-1/2 border-l">2014</td>
          </tr>
          <tr className="border-b">
          ...
          <tr className="border-b">
            ...
            <td className="px-4 py-2 text-left  w-1/2 border-l">A+</td>
          </tr>
          <tr className="border-b">
            <td className="px-4 py-2 text-left  w-1/2">
              এইচ.এস.সি / আলিম / সমমান পাসের সন
            </td>
            <td className="px-4 py-2 text-left  w-1/2 border-l">2016</td>
          </tr>
          <tr className="border-b">
            <td className="px-4 py-2 text-left  w-1/2">বিভাগ</td>
            <td className="px-4 py-2 text-left  w-1/2 border-l">
          ...
          <tr className="border-b">
            ...
            <td className="px-4 py-2 text-left  w-1/2 border-l">2020</td>
          </tr>
          <tr className="border-b">
            <td className="px-4 py-2 text-left  w-1/2">
          ...
          <tr className="border-b">
            ...
            <td className="px-4 py-2 text-left  w-1/2 border-l">নাই</td>
          </tr>
        </tbody>
      </table>
    </div>
